...
export default {
  ...
  methods:{
    ...
    square(){
        ...
        eval(this.formula)<0? this.formula = "Cannot square the negative value" : this.result=Math.sqrt(eval(this.formula));
   },
   devided(){
        console.log("divided.."); 
...
.calculator .calculator-border .calculator-items .calculator-item{
  ...
  box-shadow: 0.1rem 0.1rem 0.3rem navy;
  transition: all 0.1s;
